  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental - Empowering Your Projects by Offering Convenient and Affordable Access to Essential Construction Tools from Multiple Outlets."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental - Empowering Your Projects by Offering Convenient and Affordable Access to Essential Construction Tools from Multiple Outlets.`}
            </Text>
            <Box
